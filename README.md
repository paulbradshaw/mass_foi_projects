...
By the end of this session attendees should be able to design a data structure for an FOI project, use a range of tools including AI to extract, reshape, clean and combine data from FOI responses, and design a data validation process to check AI outputs.

## Files

A number of FOI requests can be [found in the `/foi-requests` folder](https://github.com/paulbradshaw/mass_foi_projects/tree/main/foi-requests). You can use these to test the processes outlined in this repo.
...
1. [Breaking the project down](https://github.com/paulbradshaw/mass_foi_projects/blob/main/walkthroughs/01breakitdown.md)
2. [Auditing the responses](https://github.com/paulbradshaw/mass_foi_projects/blob/main/walkthroughs/02audit.md)
3. [Extracting data from responses](https://github.com/paulbradshaw/mass_foi_projects/blob/main/walkthroughs/03extract.md)
4. [Verifying the extracted data](https://github.com/paulbradshaw/mass_foi_projects/blob/main/walkthroughs/04verification.md)
5. [Reshaping extracted data - to combine into a single dataset](https://github.com/paulbradshaw/mass_foi_projects/blob/main/walkthroughs/05reshape.md)
6. [Cleaning combined data](https://github.com/paulbradshaw/mass_foi_projects/blob/main/walkthroughs/06clean.md)
...
* Video: [Ulvund Solstad talks about experiences with vibe coding in investigations](https://www.youtube.com/watch?v=3r4grJ5zwSQ&t=8465s) (at 2:21:05) in this panel
